...
Module `sdkwork-video` · runtime code `video` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `video-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `video-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `video-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `video-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `video.sdkwork.com` | 443 ssl + 80 |
