# Runbook — sdkwork-video deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-video-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-video/bundle`, loads the image, starts
