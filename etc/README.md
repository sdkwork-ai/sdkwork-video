# sdkwork-video Source Configuration
...
| `appId` | `sdkwork-video` |
| `runtimeCode` | `video` |
| Config root | `/etc/sdkwork/video/` |
| Runtime TOML | `/etc/sdkwork/video/config.toml` |
| Secrets | `/etc/sdkwork/video/secrets/` |
| Override | `SDKWORK_VIDEO_CONFIG_FILE` |
